...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11|EN_Y_Pin|EN_X1_Pin|EN_X2_Pin
                          |DIR_Y_Pin|DIR_X1_Pin|DIR_X2_Pin|GPIO_PIN_6
  ...
  /*Configure GPIO pins : PD10 PD11 PDPin PDPin
                           ...
                           PD6 PD7 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_11|EN_Y_Pin|EN_X1_Pin
                          |EN_X2_Pin|DIR_Y_Pin|DIR_X1_Pin|DIR_X2_Pin
